    ...
    public function dropdown_link( $dropdown )
    {
        if ( is_user_logged_in() )
        {
            $item['account'] = array(
                ...
                'url'  => esc_url( home_url_multilang( $this->endpoint['account']['slug'] ) )
            );
    ...
    public function add_page_template( $template )
    {
        ...
        if ( $this->is_account_page( $wp ) )
        {
            ...
            if ( ! empty( $query_vars[0] ) )
            {
                ...
                wp_safe_redirect( esc_url( home_url_multilang( $this->endpoint['account']['slug'] . '/' . $this->endpoint['edit_account']['slug'] ) ) );
            }
